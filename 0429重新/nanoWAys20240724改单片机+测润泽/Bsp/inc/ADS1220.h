...
#include <stdbool.h>
#include "main.h"
#define SEL_ADC LL_GPIO_ResetOutputPin(AD_INV_GPIO_Port,AD_INV_Pin);
#define DIS_ADC LL_GPIO_SetOutputPin(AD_INV_GPIO_Port,AD_INV_Pin);
#define ADS1220_DRDY 		LL_GPIO_IsInputPinSet(ADC_RD_GPIO_Port, ADC_RD_Pin)
...
void ADS1220AssertCS(bool fAssert);				/* Assert/deassert CS */
void ADS1220SendByte(unsigned char TxData );		/* Send byte to the ADS1220 */
unsigned char ADS1220ReceiveByte(uint8_t TxData);			/* Receive byte from the ADS1220 */
