...
////	LL_DMA_SetMemory1Address(DMA2,LL_DMA_STREAM_0,(uint32_t)AD2Buffer);
...
//	LL_DMA_SetDataLength(DMA2,LL_DMA_STREAM_1,AD_BUFF_SIZE);
//	LL_DMA_SetPeriphAddress(DMA2,LL_DMA_STREAM_1,LL_ADC_DMA_GetRegAddr(ADC3,LL_ADC_DMA_REG_REGULAR_DATA));
//	LL_DMA_SetMemoryAddress(DMA2,LL_DMA_STREAM_1,(uint32_t)AD3Buffer);
////	LL_DMA_SetMemory1Address(DMA2,LL_DMA_STREAM_1,(uint32_t)AD4Buffer);
