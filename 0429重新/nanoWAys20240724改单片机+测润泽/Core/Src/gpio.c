...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOI, MOTOR_DIR_Pin|UART5_RD_Pin);
  ...
  GPIO_InitStruct.Pin = DA2_SCL_Pin|DA2_SDA_Pin|ABS_PW_EN_Pin|LED1_Pin
                          ...
                          |Y15_Pin|Y13_Pin|MOTOR_STDBY_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = MOTOR_INDEX_Pin|MOTOR_DIAG_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = MOTOR_DIR_Pin|Y1_Pin|UART5_RD_Pin|Y2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
