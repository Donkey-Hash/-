...
void MX_ADC1_Init(void)
{
  ...
  PB1   ------> ADC1_IN9
  */
  GPIO_InitStruct.Pin = ADC_TEMPER1_Pin|ADC_TEMPER2_Pin|AD_LL1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = AD_LL2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(AD_LL2_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC1, LL_ADC_REG_RANK_6, LL_ADC_CHANNEL_VBAT);
